                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 m-b30">
                                    ...
                                    <input type="text" class="form-control" name="fname" value="<?= $promoter['brand_name'] ?>">
                                </div>
                                <div class="col-sm-6 m-b30">
                                    <label class="form-label">Username</label>
                                    <input type="text" class="form-control" name="lname" value="<?= $promoter['username'] ?>">
                                </div>
                                <div class="col-sm-6 m-b30">
                                    <label class="form-label">Phone</label>
                                    <input type="text" class="form-control" name="phone" value="<?= $promoter['contact'] ?>">
                                </div>
                                <div class="col-sm-6 m-b30">
                                    <label class="form-label">Email address</label>
                                    <input type="email" class="form-control" name="email" value="<?= $promoter['email'] ?>">
                                </div>
                            </div>
                        </div>
