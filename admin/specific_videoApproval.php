...
if (isset($_GET['id'])) {
    $perfomance = approveVideo($_GET['id']);
} else {
                            ...
                            <div class="col-xl-6">
                                <div class="card-body pt-0">
                                    ...
                                    <ul class="post-comment d-flex mt-3">
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <?php if ($perfomance['status'] == "approved") { ?>
                                                    <form action="operations/denyVideo.php" method="post" onsubmit="return(confirm('Are you sure you want to block this video?'))">
                                                        ...
                                                        <button type="submit" name="deny" class="btn btn-danger btn-sm ms-2">Deny</button>
                                                    </form>
                                                <?php } elseif ($perfomance['status'] == "denied") { ?>
                                                    <form action="operations/approve.php" method="post" class="me-2">
                                                        <input type="hidden" name="user_id" value="<?= $perfomance['user_id'] ?>">
                                                        <input type="hidden" name="video_id" value="<?= $perfomance['video_id'] ?>">
                                                        <button type="submit" name="submit" href="#" class="btn btn-secondary btn-sm">Approve</button>
                                                    </form>
                                                    <form action="operations/deleteVideo.php" method="post" onsubmit="return(confirm('Are you sure you want to delete this video?'))">
                                                        <input type="hidden" name="video_id" value="<?= $perfomance['video_id'] ?>">
                                                        <button type="submit" href="#" class="btn btn-danger btn-sm ms-2">Delete</button>
                                                    </form>
                                                <?php } ?>
                                            </div>
                                        </li>
